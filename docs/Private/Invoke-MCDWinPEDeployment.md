...
Source: `source/Private/WinPE/Deployment/Invoke-MCDWinPEDeployment.ps1`
...
| --- | --- | --- | --- | --- |
| Window | Window | Yes | No | The WinPE main window that will be updated during the deployment workflow. |
