...
Source: `source/Private/WinPE/Deployment/Start-MCDWinPEDeploymentAsync.ps1`
...
| --- | --- | --- | --- | --- |
| Window | Window | Yes | No | The WinPE main window that will receive progress updates via Dispatcher. |
